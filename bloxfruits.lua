...
local Window = Rayfield:CreateWindow({
        Name = "Weexploit`s Blox Fruit Script!",
        LoadingTitle = "Weexploit - Bloxruits ",
        LoadingSubtitle = "Subscribe to Weexploit on YouTube!",
})
...
local Label = Tab:CreateLabel("Thanks for using Weexploit`s Blox Fruit Script!")
local Label = TabUtil:CreateLabel("Thanks for using Weexploit`s Blox Fruit Script!")
local Label = TabOther:CreateLabel("Thanks for using Weexploit`s Blox Fruit Script")
local Label = TabMobile:CreateLabel("Thanks for using Weexploit`s Blox Fruit Script")
